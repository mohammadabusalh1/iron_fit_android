...
abstract class FlutterFlowTheme {
  ...
  static void saveThemeMode(ThemeMode mode) => mode == ThemeMode.system
      ...
      : _prefs?.setBool(kThemeModeKey, mode == mode);
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFBB02);
  late Color secondary = const Color(0xFF292929);
  late Color tertiary = const Color(0xFFEB8317);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF10375C);
  ...
  late Color info = const Color(0xFF1C2127);
  late Color black = Colors.black;

  late Color newPrimary = const Color(0xFF57370d);
  late Color newSecondary = const Color(0xFFffe998);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF060c0f);
  late Color secondaryBackground = const Color(0xFF0b1519);
  late Color accent1 = const Color(0xFF10375C);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  ...
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFf03e3e);
